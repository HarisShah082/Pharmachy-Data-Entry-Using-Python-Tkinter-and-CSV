...
#_______________________________________________ Main Window ________________________________________

root = Tk()
root.title("Pharmacy Data Entry System")
...
#_____________________________________________ Add Item Entry _____________________________________
...
#__________________________________________ Data Entry Into CSV File
...
#______________________________________________________ Delete Data From Entry _______________________________
...
#_____________________________________________ Update Item In CSV File _________________________________________
...
#_____________________________________________ View Item In CSV File _________________________________________
...
#_____________________________________________ Clear Entries _________________________________________
...
#_________________________________________ Storing Variables ________________________________________
...
#_________________________________________ Creating Frames ________________________________________
...
#_________________________________________ Labeling  ________________________________________


txt_title = Label(Top, width=900, font=('arial', 24),fg='blue',text = "Pharmacy Data Entry System")
txt_title.pack()
label0 = Label(Forms, text="Medicine Name:", fg='blue',font=('arial', 16), bd=15)
label0.grid(row=0, stick="e")
label1 = Label(Forms, text="Medicine Price:",fg='blue', font=('arial', 16), bd=15)
label1.grid(row=1, stick="e")
label2 = Label(Forms, text="Quantity:",fg='blue', font=('arial', 16), bd=15)
label2.grid(row=2, stick="e")
label3 = Label(Forms, text="Category:",fg='blue', font=('arial', 16), bd=15)
label3.grid(row=3, stick="e")
label4 = Label(Forms, text="Description:",fg='blue', font=('arial', 16), bd=15)
label4.grid(row=4, stick="e")
label5 = Label(Forms, text="Discount:",fg='blue', font=('arial', 16), bd=15)
label5.grid(row=5, stick="e")
txt_result = Label(Buttons)
txt_result.pack(side=TOP)

#_________________________________________ Entry Config  ________________________________________
...
#_________________________________________ Operational Buttons ________________________________________
...
#_________________________________________ Scroll Bar ________________________________________
...
#_________________________________________ Labeling Scroll Bar Frame ________________________________________
